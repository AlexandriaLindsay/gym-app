...
import IntroImg from '../../assets/images/fitness-trainer.jpg'
            ...
            <>
                <LayoutDefault>
                    ...
                    <Section>
                        ...
                        <DoubleCol>
                            <Image style={{ width: '100px' }} className="arrow-graphic" src={Arrow} alt="Arrow Icon" />
                            <Image width="100%" src={IntroImg} alt="Coach and Girl Working Out" />
                            <div>
